<template>
    <div class="flex flex-col justify-start items-center mt-20">
        <v-dialog v-model="dialog" persistent>
            ...
            <CreateTriggerVue v-if="service" :serviceId=service!._id :onCancel="() => (dialog = false)" />
        </v-dialog>
    </div>
...
//import CreateTriggerVue from '@/components/CreateTrigger.vue';
...
onMounted(async () => {
  ...
  //  await manageTrigger.getTriggers(serviceId);
});
